...
namespace WandEnhancer.View.MainWindow
{
    public class MainWindowVm : ObservableObject
    {
        ...
        private bool _isPrivateUpdateAvailable;
        public bool IsPrivateUpdateAvailable
        {
            get => _isPrivateUpdateAvailable;
            private set => SetProperty(ref _isPrivateUpdateAvailable, value);
        }
        ...
        private async void OnUpdate(object param)
        {
            ...
            _shell.OpenPopup(new PrivateUpdatePopup(Constants.Version.ToString(), updateInfo.Version,
            ...
            }, () => _updater.GetFullChangelogAsync()), Application.Current.FindResource("private_up_popup_title") as string);
        }
        ...
        public MainWindowVm(IShellView shell, IFileDialogs dialogs)
        {
            ...
            Task.Run(async () =>
            {
                var available = await _updater.CheckForUpdates();
                Application.Current.Dispatcher.Invoke(() => IsPrivateUpdateAvailable = available);
            });
